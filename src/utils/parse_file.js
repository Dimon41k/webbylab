...
parseToObject = (array)=>array.reduce((ac, item)=>{
...
formatFieldsToDB = (array)=> array.reduce((ac, it)=>{
    let newObject ={};
    newObject['title']=it['Title'] instanceof Array ? it['Title'].map(x=>x.join(" ")).join(", ") : it['Title'],
...
export default arrayToArrayOfObjects = function (text) {
